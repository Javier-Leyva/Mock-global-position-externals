...
import io.swagger.model.GetGlobalPositionResponse;
...
public class RefreshApiController implements RefreshApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(RefreshApiController.class);
