...
import io.swagger.model.AccountsMonthlyBalanceResponseDTO;
...
@Controller
public class MonthlyBalanceApiController implements MonthlyBalanceApi {

    private static final Logger log = LoggerFactory.getLogger(MonthlyBalanceApiController.class);
